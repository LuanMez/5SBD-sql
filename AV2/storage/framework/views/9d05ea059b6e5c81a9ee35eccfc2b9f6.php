...
<body>
    <h1>Criar Novo Passageiro para o Voo <?php echo e($codigo_voo); ?></h1>

    <form action="/passageiros/salvar" method="POST">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="codigo_voo" value="<?php echo e($codigo_voo); ?>">
    ...
    <div class="form-buttons">
        <a href="/passageiros/<?php echo e($codigo_voo); ?>">
...
<?php /**PATH C:\Users\Luanm\aeroporto\resources\views/criar.blade.php ENDPATH**/ ?>